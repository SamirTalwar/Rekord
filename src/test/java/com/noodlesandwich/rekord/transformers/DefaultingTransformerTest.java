...
public final class DefaultingTransformerTest {
    ...
    transforms_any_input_to_itself() {
        Transformer<Integer, Integer> transformer = Transformers.defaultsTo(100);
        assertThat(transformer.transformInput(36), is(36));
    }

    @Test public void
    transforms_a_null_input_to_itself() {
        Transformer<Integer, Integer> transformer = Transformers.defaultsTo(999);
        assertThat(transformer.transformInput(null), is(nullValue()));
    }

    @Test public void
    transforms_a_value_to_itself() {
        Transformer<String, String> transformer = Transformers.defaultsTo("this is a default string");
